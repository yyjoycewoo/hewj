...
class ApiController extends Controller
{
    ...
    public function addCourse() {
		...
		return response()->json(Course::addCourse(Input::get('session'), Input::get('course_code'), Input::get('session_type'), Input::get('session_number')));
    }
    ...
    public function isCourseActive() {
    	...
    	return response()->json(Course::isCourseActive(Input::get('session'), Input::get('course_code'), Input::get('session_type'), Input::get('session_number')));
    }
    
    public function getCoursesCurrentLoggedInStudentIsIn() {
    	return response()->json(Course::getCoursesCurrentLoggedInStudentIsIn());
    }
    
    public function getCoursesCurrentLoggedInStaffIsTeaching() {
    	return response()->json(Course::getCoursesCurrentLoggedInStaffIsTeaching());
    }
    
    public function getAcitivatedCourses() {
    	return response()->json(Course::getAcitivatedCourses());
    }
    ...
    public function getCourseId() {
    	...
    	return response()->json(Course::getId(Input::get('session'), Input::get('course_code'), Input::get('session_type'), Input::get('session_number')));
    }
    
    public function startAttendence() {
	    if (null == Input::get('course_code')) return response()->json("Missing course_code parameter.", 400);
    
    	return response()->json(Course::startAttendence(Input::get('course_code')));
    }
    
    public function stopAttendence() {
	    if (null == Input::get('course_code')) return response()->json("Missing course_code parameter.", 400);
	    
    	return response()->json(Course::stopAttendence(Input::get('course_code')));
    }
    
    public function isAllowingAttendence() {
	    if (null == Input::get('course_code')) return response()->json("Missing course_code parameter.", 400);
	    
    	return response()->json(Course::isAllowingAttendence(Input::get('course_code')));
    }
    ...
    public function getAttendenceByCourse() {
    	...
    	return response()->json(Attendence::getAttendenceByCourse(Input::get('course_id')));
    }
    ...
    public function setAttendence() {
    	...
    	return response()->json(Attendence::setAttendence(Input::get('course_id'), Input::get('student_id')));
    }
    ...
    public function getQuestions() {
    	...
    	return response()->json(Question::getQuestions(Input::get('course_id')));
    }
    ...
    public function addQuestion() {	// date is in datetime format
    	...
    	return response()->json(Question::addQuestion(Input::get('course_id'), Input::get('question'), Input::get('date')));
    }
    ...
    public function getAnswers() {
    	...
    	return response()->json(Answer::getAnswers(Input::get('question_id')));
    }
    ...
    public function addAnswer() {	// is_correct is a boolean = 0 (false) or 1 (true)
    	...
    	return response()->json(Answer::addAnswer(Input::get('question_id'), Input::get('answer'), Input::get('is_correct')));
    }
    ...
    public function addResponse() {
    	...
    	return response()->json(Response::addResponse(Input::get('question_id'), Input::get('student_id'), Input::get('answer_id'), Input::get('answer')));
    }
    
    public function getAllResponsesFromQuestion() {
	    if (null == Input::get('question_id')) return response()->json("Missing question_id parameter.", 400);
	    
    	return response()->json(Response::getAllResponsesFromQuestion(Input::get('question_id')));
    }
    ...
    public function addTask() {	// date is in datetime format
    	...
    	return response()->json(Task::addTask(Input::get('course_id'), Input::get('date'), Input::get('name')));
    }
    
    public function getTask() {
	    if (null == Input::get('course_id')) return response()->json("Missing course_id parameter.", 400);
	    
    	return response()->json(Task::getTask(Input::get('course_id')));
    }
    ...
    public function addMark() {	// done is a boolean = 0 (false) or 1 (true)
    	...
    	return response()->json(Mark::addMark(Input::get('task_id'), Input::get('student_id'), Input::get('mark'), Input::get('done')));
    }
    
    public function getMarkByTask() {
	    if (null == Input::get('task_id')) return response()->json("Missing task_id parameter.", 400);
	    
    	return response()->json(Mark::getMarkByTask(Input::get('task_id')));
    }
}
